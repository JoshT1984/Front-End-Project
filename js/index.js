...
function equipmentPricesEmbedded() {
  ...
  let f21 = $(".f21").text(`$${newWheelArray[0]}.00`);
  let f22 = $(".f22").text(`$${newWheelArray[1]}.00`);
  let f23 = $(".f23").text(`$${newWheelArray[2]}.00`);
  let f24 = $(".f24").text(`$${newWheelArray[3]}.00`);
  let f25 = $(".f25").text(`$${newWheelArray[4]}.00`);
  let f26 = $(".f26").text(`$${newWheelArray[5]}.00`);
  let f27 = $(".f27").text(`$${newWheelArray[6]}.00`);
  let f28 = $(".f28").text(`$${newWheelArray[7]}.00`);
  let f29 = $(".f29").text(`$${newWheelArray[8]}.00`);

  let f31 = $(".f31").text(`$${newBearingArray[0]}.00`);
  let f32 = $(".f32").text(`$${newBearingArray[1]}.00`);
  let f33 = $(".f33").text(`$${newBearingArray[2]}.00`);
  let f34 = $(".f34").text(`$${newBearingArray[3]}.00`);
  let f35 = $(".f35").text(`$${newBearingArray[4]}.00`);
  let f36 = $(".f36").text(`$${newBearingArray[5]}.00`);
  let f37 = $(".f37").text(`$${newBearingArray[6]}.00`);
  let f38 = $(".f38").text(`$${newBearingArray[7]}.00`);
  let f39 = $(".f39").text(`$${newBearingArray[8]}.00`);

  let f41 = $(".f41").text(`$${newGripArray[0]}.00`);
  let f42 = $(".f42").text(`$${newGripArray[1]}.00`);
  let f43 = $(".f43").text(`$${newGripArray[2]}.00`);
  let f44 = $(".f44").text(`$${newGripArray[3]}.00`);
  let f45 = $(".f45").text(`$${newGripArray[4]}.00`);
  let f46 = $(".f46").text(`$${newGripArray[5]}.00`);
  let f47 = $(".f47").text(`$${newGripArray[6]}.00`);
  let f48 = $(".f48").text(`$${newGripArray[7]}.00`);
  let f49 = $(".f49").text(`$${newGripArray[8]}.00`);

  let f51 = $(".f51").text(`$${newTruckArray[0]}.00`);
  let f52 = $(".f52").text(`$${newTruckArray[1]}.00`);
  let f53 = $(".f53").text(`$${newTruckArray[2]}.00`);
  let f54 = $(".f54").text(`$${newTruckArray[3]}.00`);
  let f55 = $(".f55").text(`$${newTruckArray[4]}.00`);
  let f56 = $(".f56").text(`$${newTruckArray[5]}.00`);
  let f57 = $(".f57").text(`$${newTruckArray[6]}.00`);
  let f58 = $(".f58").text(`$${newTruckArray[7]}.00`);
  let f59 = $(".f59").text(`$${newTruckArray[8]}.00`);

  let f61 = $(".f61").text(`$${newToolArray[0]}.00`);
  let f62 = $(".f62").text(`$${newToolArray[1]}.00`);
  let f63 = $(".f63").text(`$${newToolArray[2]}.00`);
  let f64 = $(".f64").text(`$${newToolArray[3]}.00`);
  let f65 = $(".f65").text(`$${newToolArray[4]}.00`);
  let f66 = $(".f66").text(`$${newToolArray[5]}.00`);
  let f67 = $(".f67").text(`$${newToolArray[6]}.00`);
  let f68 = $(".f68").text(`$${newToolArray[7]}.00`);
  let f69 = $(".f69").text(`$${newToolArray[8]}.00`);

  let f71 = $(".f71").text(`$${newHardwareArray[0]}.00`);
  let f72 = $(".f72").text(`$${newHardwareArray[1]}.00`);
  let f73 = $(".f73").text(`$${newHardwareArray[2]}.00`);
  let f74 = $(".f74").text(`$${newHardwareArray[3]}.00`);
  let f75 = $(".f75").text(`$${newHardwareArray[4]}.00`);
  let f76 = $(".f76").text(`$${newHardwareArray[5]}.00`);
  let f77 = $(".f77").text(`$${newHardwareArray[6]}.00`);
  let f78 = $(".f78").text(`$${newHardwareArray[7]}.00`);
  let f79 = $(".f79").text(`$${newHardwareArray[8]}.00`);
}
